                    ...
                    <?php
                            if (isset($_POST['search'])) {
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    'openBookModal("Book Title", "Author Name", "Number of Pages");',
                                    '</script>';
                                    
                                    echo '<div class="book-card" onclick="openBookModal(\'' . $row['Title'] . '\', \'' . $author['First_Name'] .
                                     ' ' . $author['Last_Name'] . '\', \'' . $row['Pages'] . '\')">';
