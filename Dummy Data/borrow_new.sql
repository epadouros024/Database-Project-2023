...
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (1, 0, '2023-06-02', '2023-06-09', 21, 11, 21 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (2, 0, '2023-06-01', '2023-06-08', 21, 23, 21 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (3, 0, '2023-06-01', '2023-06-08', 22, 1, 22 );

insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (4, 0, '2023-05-31', '2023-06-07, 21', 18, 31 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (5, 0, '2023-05-30', '2023-06-06', 23, 22, 33 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (6, 0, '2023-05-29', '2023-06-05', 23, 28, 33 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (7, 0, '2023-06-02', '2023-06-09', 24, 36, 34 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (8, 0, '2023-06-01', '2023-06-08', 24, 37, 34 );

insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (9, 0, '2023-05-31', '2023-06-07', 21, 153, 10 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (10, 0, '2023-05-31', '2023-06-07', 21, 123, 12 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (11, 0, '2023-05-30',' 2023-06-06', 21, 154, 12 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (12, 0, '2023-05-30', '2023-06-06', 22, 82, 14 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (13, 0, '2023-05-31', '2023-06-07', 22, 85, 15 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (14, 0, '2023-06-01', '2023-06-08', 23, 86, 17 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (15, 0, '2023-06-01', '2023-06-08', 23, 121, 17 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (16, 0, '2023-05-31', '2023-06-07', 24, 87, 19 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (17, 0,' 2023-05-30','2023-06-06', 24, 124, 20 );

insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (18, 0, '2023-06-01', '2023-06-08', 21, 111, 50 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
...
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
            values (29, 0, '2023-06-01', '2023-06-08', 22, 177, 61 );
insert into borrow (Borrow_ID, Status,Date_of_Borrow ,Day_of_Return, School_Admin_Id, Books_Book_Id, User_ID) 
